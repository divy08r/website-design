            ...
            <Navbar />
            {
                farmer.map((farmerdata) => {
                    return (
                        ...
                        IncometoDate= {farmerdata.incometodate} lastmonthincome={farmerdata.lastmonthincome} key={farmerdata.name} Name={farmerdata.name}  location = {farmerdata.location} phone={farmerdata.phone}  mail = {farmerdata.email} farmimage1={farmerdata.farm1img} farmimage2 = {farmerdata.farm2img}
